...
export class Livraison {
  @Column("integer", { primary: true, name: "id_liv" })
  idLiv: number;
  ...
  @JoinColumn([{ name: "id_zone_Zone", referencedColumnName: "idZone" }])
  idZoneZone: Zone;
  ...
  @JoinColumn([{ name: "id_zone_Zone1", referencedColumnName: "idZone" }])
  idZoneZone2: Zone;
