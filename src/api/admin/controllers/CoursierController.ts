    ...
    private async statByDate(router :Router) : Promise<void>{
        router.get("/stat",async(req:Request,res:Response,next:NextFunction)=>{
            try{
                ...
                .select(`coursier.nomCoursier as 'nomCoursier' ,coursier.prenomCoursier as 'prenomCoursier', coursier.idCoursier as 'idCoursier' , count(coursier.idCoursier) as total`)
